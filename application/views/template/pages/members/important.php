...
<ul>
    ...
    <li>
        <ul class="inbox-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="<?=site_url('important')?>"><span class="fa fa-caret-right"></span> Important</a></li>    
        </ul>
    </li>
...
<div class="content">
    <div class="header">
        ...
        <ul class="breadcrumb">
            <li>Inbox</li>
            <li class="active"><a href="<?= site_url('archieve')?>"> Important</a></li>
        </ul>
    </div>  
...
<form method="POST" name="FormMessageSend" novalidate>
    <ul class="nav nav-tabs">
        <li class="active"><a href="#important" data-toggle="tab">Important</a></li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <br>
            <div id="myTabContent" class="tab-content">
            <div class="tab-pane active in" id="important">
