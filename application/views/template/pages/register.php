...
<div class="panel-body">
    <form name="FormRegister" action="<?= site_url('execute/createuser')?>" id="register" method="POST" novalidate>
        ...
        <div class="form-group">
            ...
            <input type="text" ng-model="fullname" name="fullname" class="form-control" ng-pattern="/^(.*?[a-zA-Z]){2,}$/" required>
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" ng-model="email" name="email" ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/" required>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="contact" ng-model="contact" ng-pattern="/^(.*?[0-9]){10,}$/" ng-maxlength="10"required>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control span12" ng-model="username" name="username" ng-minlength="6" ng-maxlength="50" required>
        ...
        <label>Confirm Password</label>
            <input type="password" class="form-control" name="cpassword" ng-model="cpassword" ng-minlength="6" ng-maxlength="30" password-verify="{{password}}">
        ...
        <button type="submit" id="register" ng-disabled="!FormRegister.$valid" class="btn btn-primary pull-right">Register</button>
